...
int main( int argc, char** argv )
{
  ...
  while (ros::ok())
  {
    ...
    station1_marker.pose.position.x = 3.8521378943520306;
    station1_marker.pose.position.y = 1.3198391217678465;
    station1_marker.pose.position.z = 0.22999999999999998;
    station1_marker.pose.orientation.x = 0.0;
    station1_marker.pose.orientation.y = 0.0;
    station1_marker.pose.orientation.z = -0.04543464033876337;
    station1_marker.pose.orientation.w = 0.9989673135079482;
